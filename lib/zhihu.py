...
class Answer:
    ...
    def get_img(self):
        ...
        images_list = soup.findAll('img',class_='origin_image')
        result = []
        for i in images_list:
            result.append(i.attrs['data-actualsrc'])
        return result
        ...
        if len(answer_list) == 0:
            ...
            for answer in answer_list:
                if not answer.find("p", class_="note"):
                    ...
                    question = Question(question_url, question_title)
                    answer_url = "http://www.zhihu.com" + answer.find("div", class_="zm-item-rich-text").attrs['data-entry-url']
                    author = None
